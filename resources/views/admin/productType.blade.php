...
@section('content')
    ...
    <div class="block">
        <form class="form-horizontal" action="@if (empty($obj->pk_id)){{url('admin/productType')}} @else {{url('admin/productType/'.$obj->pk_id)}} @endif" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
